  ...
  return (
    <div className='postMainLayout'>
      ...
      <div id='postSnapShotLayout'>
        <PostImgSnapShot name="HB Roti" img="./images/HB Roti.jpg" desc="HB Roti is a healthy version of normal chapathi but increases your Hemoglobin(HB) level" path="/post1"/>
